...
/* harmony import */ var _pieceState__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../pieceState */ "./src/pieceState.js");
/* harmony import */ var _AI_AI__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../AI/AI */ "./src/AI/AI.js");
...
const triangoBoard = _triangoBoard__WEBPACK_IMPORTED_MODULE_2__["TriangoBoard"].instance;
...
GameStates.debug = (() => {
  ...
  const btnSwapColor = new _canvasButton__WEBPACK_IMPORTED_MODULE_1__["default"](210, 50, 80, 50, 20, 'black', () => {
    triangoBoard.setCurrentColor(btnSwapColor.text === 'black' ? _pieceState__WEBPACK_IMPORTED_MODULE_3__["default"].white : _pieceState__WEBPACK_IMPORTED_MODULE_3__["default"].black);
  ...
  const btnClear = new _canvasButton__WEBPACK_IMPORTED_MODULE_1__["default"](460, 50, 80, 50, 20, 'clear', () => {
    triangoBoard.clear();
  });
  o.handleInput = () => {
    const x = input.mouseX;
...
GameStates.twoP = (() => {
  ...
  function swapColor() {
    triangoBoard.setCurrentColor(triangoBoard.getCurrentColor() === _pieceState__WEBPACK_IMPORTED_MODULE_3__["default"].black
      ? _pieceState__WEBPACK_IMPORTED_MODULE_3__["default"].white : _pieceState__WEBPACK_IMPORTED_MODULE_3__["default"].black);
  }
  ...
  o.render = () => {
    ...
    ctx.fillStyle = triangoBoard.getCurrentColor() === _pieceState__WEBPACK_IMPORTED_MODULE_3__["default"].black ? 'black' : 'white';
